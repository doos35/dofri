...
import { Settings, Home, LogIn, LogOut, Sun, Moon } from 'lucide-react';
          ...
          <nav className="flex items-center gap-2">
            ...
            {isAuthenticated ? (
              <>
                ...
                <span className="hidden sm:inline text-xs text-gray-400 dark:text-gray-500">{username}</span>
                <button
                  onClick={handleLogout}
                  className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all duration-200"
                >
